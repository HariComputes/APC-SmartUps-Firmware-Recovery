...
Applicable Models:
==================
Smart-UPS SMT UXI-CH UPSs rated 1, 2.2, 3 kVA with ID 1040  
...
Release Notes (UPS01.2):
========================
1. Adds Green mode configuration to display.


Release Notes (UPS01.1):
========================
1. External battery packages show in display
