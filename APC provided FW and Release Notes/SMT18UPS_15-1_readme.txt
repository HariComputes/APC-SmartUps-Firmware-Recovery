...
Release Notes (UPS15.1):
SHA256: ce5a6e101717686544c4c1053e7c0e5c81a72db72c759000113eb10d5d537783
=====================
1.Fix when the low battery shutdown, probabilistic occurrence, group 1 without output
2.Change UI display issue and control logic, change the Japanese language display content
