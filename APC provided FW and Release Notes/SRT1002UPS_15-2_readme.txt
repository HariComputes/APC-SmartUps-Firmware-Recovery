...
UPS firmware update compatibility:		  
	...
	Note: UPS ID 1002 will not support firmware upgrade with UPS output ON feature amd two step firmware upgrade process. 
...
Release Notes (UPSa05.2):
=========================
1. Improved system behavior to eliminate false triggering of Site Wiring event.
...
SRT8KXLT, SRT8KXLT-IEC , SRT8KRMXLT, SRT8KRMXLT-IEC, SRT10KXLT, SRT10KXLT-IEC, SRT10KRMXLT, SRT10KRMXLT-IEC: 

1.  Updated firmware file index in ENC file. 

Release Notes (UPS 02.1):
=========================

SRT8KXLI, SRT8KRMXLI, SRT10KXLI, SRT10KRMXLI, DLRT8KRMXLI:
